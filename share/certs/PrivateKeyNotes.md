...
allowing somebody to distribute a Liquid-Qt.app or elements-qt-setup.exe with a valid
...
that the elements-qt.exe file inside the installer had not been tampered with.
